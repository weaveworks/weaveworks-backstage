...
describe('useWeaveFluxDeepLink', () => {
    ...
    describe('when configured with a gitops url', () => {
        ...
        it('calculates a url for GitRepositories', async () => {
            ...
            expect(result.current).toBe('https://example.com/git_repository/details?clusterName=&name=podinfo&namespace=default');
        });

        it('does not calculate a URL for OCIRepositories', async () => {
            gitOpsUrl = 'https://example.com';
