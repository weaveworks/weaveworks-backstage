...
describe('useWeaveFluxDeepLink', () => {
    ...
    describe('when configured with a gitops url', () => {
        it('calculates a url for HelmReleases', async () => {
            ...
            expect(result.current).toBe('https://example.com/helm_release/details?clusterName=&name=normal&namespace=default');
        });
        ...
        it('calculates a url for GitRepositories', async () => {
            ...
            expect(result.current).toBe('https://example.com/git_repo/details?clusterName=&name=podinfo&namespace=default');
        });
        ...
        it('calculates a url for OCIRepositories', async () => {
            ...
            expect(result.current).toBe('https://example.com/oci/details?clusterName=&name=podinfo&namespace=default');
        });
    });
